...
If you’d like to directly access a hosted node you can use Infura. You can also use the free ones provided by [Cloudflare](https://cloudflare-eth.com/) or [Alchemy](https://www.alchemy.com/ethereum):
...
Alternatives to web3.js like [Ethers.js](https://docs.ethers.io/) do exist. In the next tutorial we’ll see [how to easily listen to new incoming blocks on the blockchain and see what they contains](https://ethereumdev.io/listening-to-new-transactions-happening-on-the-blockchain/).
